  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {/* Card 1 */}
        <Card className="group relative flex flex-col border-slate-200 transition-all duration-300 hover:border-blue-300 hover:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] cursor-pointer">
        ...
        {/* Card 4 (Paused) */}
        <Card className="group relative flex flex-col border-slate-200 opacity-80 transition-all duration-300 hover:border-blue-300 hover:opacity-100 hover:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] cursor-pointer">
          <CardHeader className="pb-1 pt-3">
            <div className="mb-2 flex items-start justify-between">
