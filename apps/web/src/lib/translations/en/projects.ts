export const projects = {
  ...
  'projectCreate.selectModel': 'Select model',
  'projectCreate.selectModelDesc': 'Pick one or more models. The first becomes the active one — switch between them anytime from the project header. Models marked (custom) use your own key or LLM.',
  'projectCreate.noModels': 'No models available yet.',
  'projectCreate.addModels': 'Add models in Team Settings → Models',
  'projectCreate.modelsHint': 'Don’t see your model?',
  ...
  'projDetail.arsoCalling': 'Fetching ARSO {tool}…',
  'projDetail.arsoCalled': 'ARSO {tool}',
  'projDetail.arsoToolWeather': 'weather',
  'projDetail.arsoToolAir': 'air quality',
  'projDetail.arsoToolRiver': 'water levels',
  'projDetail.arsoSource': 'Source: Slovenian Environment Agency (ARSO)',
