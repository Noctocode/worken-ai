...
export const projects: Record<keyof typeof projectsEn, string> = {
  ...
  'projectCreate.selectModel': 'Izberi model',
  'projectCreate.selectModelDesc': 'Izberi enega ali več modelov. Prvi postane aktivni — med njimi preklapljaš kadarkoli v glavi projekta. Modeli z oznako (custom) uporabljajo tvoj lasten ključ ali LLM.',
  'projectCreate.noModels': 'Zaenkrat ni razpoložljivih modelov.',
  'projectCreate.addModels': 'Dodaj modele v Nastavitve ekipe → Modeli',
  'projectCreate.modelsHint': 'Ne najdeš svojega modela?',
  ...
  'projDetail.skillApplied': 'Veščina: {name}',
  'projDetail.arsoCalling': 'Pridobivam ARSO {tool}…',
  'projDetail.arsoCalled': 'ARSO {tool}',
  'projDetail.arsoToolWeather': 'vreme',
  'projDetail.arsoToolAir': 'kakovost zraka',
  'projDetail.arsoToolRiver': 'vodostaj',
  'projDetail.arsoSource': 'Vir: Agencija RS za okolje (ARSO)',
