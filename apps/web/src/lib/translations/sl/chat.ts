...
export const chat: Record<keyof typeof chatEn, string> = {
  ...
  'chatComp.imageRemove': 'Odstrani sliko',
  'chatComp.imageTooMany': 'Priložiš lahko največ 4 slike.',
  'chatComp.imageBadType': 'Nepodprta vrsta slike. Uporabi PNG, JPEG, WEBP ali GIF.',
  'chatComp.imageTooLarge': 'Slika je prevelika (največ 5 MB).',
  'chatComp.imageReadFailed': 'Slike ni bilo mogoče prebrati.',
