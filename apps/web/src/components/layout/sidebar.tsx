...
export const SidebarContent = () => (
  <div className="flex h-full flex-col">
    ...
    <div className="mt-auto border-t p-4">
      <div className="group flex cursor-pointer items-center gap-3 rounded-lg p-2 transition-colors hover:bg-slate-50">
        ...
        <div className="flex-1 overflow-hidden">
          ...
          <p className="truncate text-xs text-slate-500">jane@worken.ai</p>
        </div>
        <Settings className="h-5 w-5 text-slate-400 transition-colors group-hover:text-slate-600" />
      </div>
    </div>
  </div>
);
